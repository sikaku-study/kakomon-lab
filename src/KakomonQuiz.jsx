    ...
    questions: [
      {
        ...
        question:
          "水質汚濁に係る環境基準の達成期間等に関する記述中、下線を付した箇所のうち、誤っているものはどれか。\n\n生活環境の保全に関する環境基準については、各公共用水域ごとに、おおむね次の区分により、施策の推進とあいまちつつ、可及的速かにその達成維持を図るものとする。\n\n(1)現に著しい人口集中、大規模な工業開発等が進行している地域に係る水域で著しい水質汚濁が生じているものまたは生じつつあるものについては、5年以内に達成することを目途とする。ただし、(2)これらの水域のうち、水質汚濁が極めて著しいため、水質の改善のための施策を総合的に講じても、この期間内における達成が困難と考えられる水域については、(3)水域類型を適宜設定することにより、段階的に当該水域の水質の改善を図りつつ、極力環境基準の速やかな達成を期することとする。\n\n(4)水質汚濁防止を図る必要のある公共用水域のうち、（一）の水域以外の水域については、(5)設定後直ちに達成され、維持されるよう水質汚濁の防止に努めることとする。",
        choices: [
          "5年以内に達成することを目途とする",
          "水質汚濁が極めて著しいため、施策を総合的に講じても達成が困難",
          "水域類型を適宜設定することにより",
    ...
    questions: [
      {
        ...
        question:
          "地下水の水質汚濁に係る環境基準に関する記述中、下線を付した箇所のうち、誤っているものはどれか。\n\n地下水の水質の測定の実施は、別表の項目の欄に掲げる項目ごとに、地下水の流動状況等を勘案して、当該項目に係る地下水の水質汚濁の状況を的確に把握できると認められる場所において行うものとする。\n\n環境基準は、設定後直ちに達成され、維持されるように努めるものとする（ただし、汚染が専ら特定の汚染源によることが明らかであると認められる場合を除く。）。",
        choices: [
          "地下水の流動状況等を勘案して",
          "的確に把握できると認められる場所",
          "設定後直ちに達成され、維持されるように努める",
          "専ら",
          "特定の汚染源",
        ],
        answer: 4,
        note:
          "環境省告示の原文は「汚染が専ら自然的原因によることが明らかであると認められる場合を除く」であり、「特定の汚染源」は誤り（下線区切りは原本レイアウトから一部推定を含む）。",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "r02-osui-24",
        question:
          "燃焼酸化－赤外線式のTOC計を用いた測定に関する記述中、下線を付した箇所のうち、誤っているものはどれか。\n\n1チャンネル方式は自動計測にも使用される。試料に(1)アルカリを加えてpH10以上とし、これに(2)パージガスを通気して無機体炭素を除去する。この試料を(3)燃焼し、生成した二酸化炭素を(4)非分散型赤外線ガス分析計で測定する。",
        choices: [
          "自動計測にも使用される",
          "アルカリを加えてpH10以上とし",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          "60日を経過した後でなければ",
          "特定施設若しくは有害物質貯蔵指定施設の構造等の変更をしてはならない",
          "事項の内容が相当であると認めるとき",
          "前項に規定する期間を",
          "延長することができる",
        ],
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "r01-osui-21",
        question:
          "pH標準液の保存方法に関する記述中、下線を付した箇所のうち、誤っているものはどれか。\n\npH標準液は、(1)共栓ポリエチレン瓶又は(2)共栓ほうけい酸ガラス瓶に入れ、(3)密栓して保存する。長期間保存した場合は、新しく調製したものと比較し有効性を確認する。(4)りん酸塩標準液は空気中の二酸化炭素を吸収し変質しやすい。使用した(5)標準液は元の瓶には戻さず廃棄する。",
        choices: [
          "共栓ポリエチレン瓶",
          "共栓ほうけい酸ガラス瓶",
          "密栓して保存",
